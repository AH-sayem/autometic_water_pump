...
void setup() {
    ...
    // bluettoth section 
      ...
      pinMode(8, OUTPUT);    // this is new output pin 8 number pin 
      Serial.begin(9600);
...
void loop() {
  ...
  if(val=='1')          // according to the mobile 
  {
  digitalWrite(8, LOW);      // change here 
  } 
  else if (val=='2')         // according to the mobile 
  {
  digitalWrite(8, HIGH);     // change here 
  }
    //  delay(100);



    // blutooth section end 
